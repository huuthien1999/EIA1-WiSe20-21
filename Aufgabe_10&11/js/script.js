...
function drawListToDOM() {
    ...
    var _loop_1 = function (index_1) {
         ...
         */
        todo.innerHTML = "<span class='check " + test[index_1].todosChecked + "'><i class='fas fa-check'></i></span>"
            + test[index_1].todosText +
    ...
    for (var index_1 = 0; index_1 < test.length; index_1++) {
        _loop_1(index_1);
    }
    updateCounter();
}
function updateCounter() {
    var done = 0;
    var undone = 0;
    for (var index_2 = 0; index_2 < test.length; index_2++) {
        if (test[index_2].todosChecked == true) {
            done++;
            console.log(done);
        }
        else {
    ...
    counterDOMElement.innerHTML = test.length + " in total";
...
function toggleCheckState(index) {
     ...
     */
    test[index].todosChecked = !test[index].todosChecked;
    /**
     * Die zentrale Funktion, um die Liste des ToDo-Arrays in den DOM zu rendern
     * wird wieder getriggert
     */
